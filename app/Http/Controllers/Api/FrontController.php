...
class FrontController extends Controller
{
    ...
    public function companiesByMajors($section, $major)
    {
        ...
        $MajorCompanies = CompanyMajorMdl::where('major_id', $major->id)->get()->pluck('major_id', 'company_id')->all();
     ...
     * ============================
     */
    public function project(ProjectMdl $project)
    {
     ...
     * ============================
     */
    public function singleProduct(ProductMdl $product)
    {
    ...
    public function productEnquiry(Request $req)
    {
        $valid = Validator::make($req->all(), [
            ...
            'useproduct_idr_id.required' => __('general.Cant complete Your Request Now'),
