        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('section.Major') }}/ <strong class="text-primary small">
                  @if (App::getLocale()=='ar')
                  {{ $major->name_ar }}
                  @else
                  {{ $major->name_en }}
                    ...
                    <div class="profile-ud-list">
                      ...
                      <div class="profile-ud-item">
                        <div class="profile-ud wider">
                          ...
                          <span class="profile-ud-value">{{ $major->name_ar }}</span>
                        </div>
                      </div>
                      ...
                      <div class="profile-ud-item">
                        <div class="profile-ud wider">
                          ...
                          <span class="profile-ud-value">{{ $major->name_en }}</span>
                        </div>
                      </div>
                      ...
                      <div class="profile-ud-item">
                        <div class="profile-ud wider">
                          ...
                          <span class="profile-ud-value">{{ date('d M, Y', strtotime($major->created_at)) }}</span>
                        </div>
                      </div>
                      ...
                      <div class="profile-ud-item">
                        <div class="profile-ud wider">
                          ...
                          <span class="profile-ud-value">{{ date('d M, Y', strtotime($major->updated_at)) }}</span>
                        </div>
                      </div>
