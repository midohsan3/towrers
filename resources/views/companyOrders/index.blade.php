              ...
              <div class="card-inner p-0">
                <table class="nk-tb-list nk-tb-ulist">
                  ...
                  <tbody>
                    ...
                    <tr class="nk-tb-item">
                      <td class="nk-tb-col">
                        <a href="{{ route('c-company.order.show',$order->id) }}">
                          <div class="user-card">
                        ...
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-info" data-placement="top"
                              title="{{ __('order.Complete') }}" data-orderid="{{ $order->id }}" data-toggle="modal"
                              data-target="#completeMdl">
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('c-company.order.show',$order->id) }}" class="text-primary">
...
<div class="modal fade zoon" tabindex="-1" id="completeMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('c-company.order.complete') }}" method="POST">
          @csrf
...
<script>
  'use strict';
        $(function() {      
            ...
            ====================
            */
            $('#completeMdl').on('show.bs.modal', function(e) {
