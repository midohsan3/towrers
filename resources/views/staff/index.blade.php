                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('staff.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('staff.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                ...
                <table class="nk-tb-list nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      ...
                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('general.Roles') }}</span>
                      </th>

                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('general.Status') }}</span></th>

                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('general.Submitted At') }}</span>
                      </th>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('staff.edit',$user->id) }}" class="btn btn-trigger btn-icon text-success"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  @can('staff-edit')
                                  <li>
                                    <a href="{{ route('staff.edit',$user->id) }}" class="text-success">
