        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            ...
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('section.Majors List') }}</h3>
              <div class="nk-block-des text-soft">
                <p>{{ __('general.You have total') }} {{ number_format($majorsCount,0) }} {{ __('section.Major') }}.
                </p>
              </div>
            </div>
                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('major.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('major.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                ...
                <table class="nk-tb-list nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      ...
                      <th class="nk-tb-col tb-col-mb"><span class="sub-text">{{ __('section.Section') }}</span></th>
                  ...
                  <tbody>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <a href="{{ route('major.show',$major->id) }}">
                          <div class="user-card">
                            <div class="user-avatar bg-primary">
                              <span class="text-uppercase">{{ substr($major->name_en,0,2) }}</span>
                            </div>
                            <div class="user-info">
                              <span class="tb-lead ">
                                @if (App::getLocale()=='ar')
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span>
                          @if (App::getLocale()=='ar')
                          {{ $major->sectionMajor->name_ar }}
                          @else
                          {{ $major->sectionMajor->name_en }}
                          @endif
                        </span>
                      </td>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('major.edit',$major->id) }}" class="btn btn-trigger btn-icon text-success"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" data-placement="top"
                              title="{{ __('general.Deactivate') }}" data-majorid="{{ $major->id }}"
                              data-majornameen="{{ $major->name_en }}" data-majornamear="{{ $major->name_ar }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-success" data-placement="top"
                              title="{{ __('general.Activate') }}" data-majorid="{{ $major->id }}"
                              data-majornameen="{{ $major->name_en }}" data-majornamear="{{ $major->name_ar }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" title="{{ __('general.Delete') }}"
                              data-majorid="{{ $major->id }}" data-majornameen="{{ $major->name_en }}"
                              data-majornamear="{{ $major->name_ar }}" data-toggle="modal" data-target="#deleteMdl">
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('major.show',$major->id) }}" class="text-primary">
                                  ...
                                  <li>
                                    <a href="{{ route('major.edit',$major->id) }}" class="text-success">
                                  ...
                                  @if ($major->status==1)
                                  <li>
                                    <a href="#" class="text-danger" data-majorid="{{ $major->id }}"
                                      data-majornameen="{{ $major->name_en }}" data-majornamear="{{ $major->name_ar }}"
                                      data-toggle="modal" data-target="#deactivateMdl">
                                      <i class="icon fal fa-power-off"></i>
                                  ...
                                  @else
                                  <li>
                                    <a href="#" class="text-success" data-majorid="{{ $major->id }}"
                                      data-majornameen="{{ $major->name_en }}" data-majornamear="{{ $major->name_ar }}"
                                      data-toggle="modal" data-target="#activateMdl">
                                      <i class="icon fal fa-power-off"></i>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('major.activate') }}" method="POST">
          @csrf
          <input hidden id="major_id" name="majorID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
              {{ __('general.Are You Sure You Want Activate') }}
              <strong>
                @if (App::getLocale() == 'ar')
                <span id="major_namear"></span>
                @else
                <span id="major_nameen"></span>
                @endif
...
<div class="modal fade zoon" tabindex="-1" id="deactivateMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('major.deactivate') }}" method="POST">
          @csrf
          <input hidden id="major_Id" name="majorID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('major.destroy') }}" method="POST">
          @csrf
          <input hidden id="majorId" name="majorID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
              {{ __('general.Are You Sure You Want Delete') }}
              <strong>
                @if (App::getLocale()=='ar')
                <span id="majorNamear"></span>
                @else
                <span id="majorNameen"></span>
                @endif
        ...
        $(function() {   
            ...
            */
            $('#activateMdl').on('show.bs.modal', function(e) {
                ...
                let id = button.data('majorid');
                let nameEn = button.data('majornameen');
                let nameAr = button.data('majornamear');
                //console.log(id);
                var modal = $(this);
                modal.find('.modal-body #major_id').val(id);
                modal.find('.modal-body #major_nameen').html(nameEn);
                modal.find('.modal-body #major_namear').html(nameAr);
            });
            ...
            */
            $('#deleteMdl').on('show.bs.modal', function(e) {
                ...
                //console.log(id);
                var modal = $(this);
                modal.find('.modal-body #majorId').val(id);
                modal.find('.modal-body #majorNameen').html(nameEn);
                modal.find('.modal-body #majorNamear').html(nameAr);
            });
