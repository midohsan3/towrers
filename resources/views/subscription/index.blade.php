        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            ...
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('package.Subscribers List') }}</h3>
              <div class="nk-block-des text-soft">
                <p>{{ __('general.You have total') }} {{ number_format($subscribersCount,0) }}
                  {{ __('package.Subscriber') }}.
                </p>
              </div>
            </div>
                      ...
                      <div class="drodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <ul class="link-list-opt no-bdr">
                            <li><a href="{{ route('subscription.index') }}"><span>{{ __('general.All') }}</span></a>
                            </li>
                ...
                <table class="nk-tb-list nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      <th class="nk-tb-col">
                        <span class="sub-text">{{ __('company.Company') }}</span>
                      </th>

                      <th class="nk-tb-col tb-col-mb"><span class="sub-text">{{ __('package.Package') }}</span></th>
                      ...
                      <th class="nk-tb-col tb-col-mb"><span class="sub-text">{{ __('package.Payment Status') }}</span>
                      </th>
                  ...
                  <tbody>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <a href="=====">
                          <div class="user-card">
                            <div class="user-avatar bg-primary">
                              <span class="text-uppercase">{{ substr($subscriber->userSubscription->name,0,2) }}</span>
                            </div>
                            <div class="user-info">
                              <span class="tb-lead ">
                                @if (App::getLocale()=='ar')
                                {{ $subscriber->userSubscription->companyUser->name_ar }}
                                @else
                                {{ $subscriber->userSubscription->companyUser->name_en }}
                                @endif
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span class="tb-lead">
                          @if (App::getLocale()=='ar')
                          {{ $subscriber->packageSubscription->name_ar }}
                          @else
                          {{ $subscriber->packageSubscription->name_en }}
                          @endif
                        </span>
                      </td>

                      <td class="nk-tb-col tb-col-md">
                        <span class="">{{date('d M,Y',strtotime($subscriber->started_at))}}</span>

                      </td>

                      <td class="nk-tb-col tb-col-md">
                        <span class="">{{date('d M,Y',strtotime($subscriber->ended_at))}}</span>
                      ...
                      <td class="nk-tb-col tb-col-md">
                        @if ($subscriber->pay_status==1)
                        <span class="tb-status text-success">{{ __('package.Paid') }}</span>
                        @else
                        <span class="tb-status text-danger">{{ __('package.Pending') }}</span>
                        @endif
                      </td>
                        ...
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" data-placement="top"
                              title="{{ __('general.Deactivate') }}" data-packageid="{{ $subscriber->id }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-success" data-placement="top"
                              title="{{ __('general.Activate') }}" data-packageid="{{ $subscriber->id }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" title="{{ __('general.Delete') }}"
                              data-packageid="{{ $subscriber->id }}" data-toggle="modal" data-target="#deleteMdl">
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  @if ($subscriber->status==1)
                                  <li>
                                    <a href="#" class="text-danger" data-packageid="{{ $subscriber->id }}"
                                      data-toggle="modal" data-target="#deactivateMdl">
                                      <i class="icon fal fa-power-off"></i>
                                  ...
                                  @else
                                  <li>
                                    <a href="#" class="text-success" data-packageid="{{ $subscriber->id }}"
                                      data-toggle="modal" data-target="#activateMdl">
                                      <i class="icon fal fa-power-off"></i>
