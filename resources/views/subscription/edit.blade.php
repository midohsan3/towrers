                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="tinymce-basic form-control" name="feature_ar"
                            placeholder="{{ __('package.Arabic Features Here') }}">{{ old('feature_ar',$package->features_ar) }}</textarea>
                          @error('feature_ar')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="tinymce-basic form-control" name="feature_en"
                            placeholder="{{ __('package.English Features Here') }}">{{ old('feature_en', $package->features_en) }}</textarea>
                          @error('feature_en')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
