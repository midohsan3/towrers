              ...
              <div class="card-inner card-inner-lg">
                ...
                <div class="nk-block">
                  <div class="nk-data data-list">
                    <div class="data-head">
                      <h6 class="overline-title">Main Information</h6>
                    </div>
                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                      <div class="data-col">
                        <span class="data-label">{{ __('general.Arabic Name') }}</span>
                        <span class="data-value">{{ Auth::user()->companyUser->name_ar }}</span>
                      </div>
                    ...
                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                      <div class="data-col">
                        <span class="data-label">{{ __('general.English Name') }}</span>
                        <span class="data-value">{{ Auth::user()->companyUser->name_en }}</span>
                      </div>
                      <div class="data-col data-col-end"><span class="data-more"> <em
                            class="icon ni ni-forward-ios"></em></span></div>
                    </div><!-- data-item -->
                    ...
                    <div class="data-item">
                      <div class="data-col">
                        <span class="data-label">Email-Official</span>
                        <span class="data-value">{{ $company_mail->chanel }}</span>
                      </div>
                    ...
                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                      <div class="data-col">
                        ...
                        @if (array_key_exists('1',$cons))
                        <span class="data-value text-soft">{{ $cons["1"] }}</span>
                        @else
                    ...
                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                      <div class="data-col">
                        <span class="data-label">Fax Number</span>
                        @if (array_key_exists('2',$cons))
                        <span class="data-value text-soft">{{ $cons["2"] }}</span>
                        @else
                        <span class="data-value text-soft">Not add yet</span>
                        @endif
                      </div>
                    ...
                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                      <div class="data-col">
                        ...
                        @if (array_key_exists('3',$cons))
                        <span class="data-value text-soft">{{ $cons["3"] }}</span>
                        @else
                        <span class="data-value text-soft">Not add yet</span>
                        @endif
                      </div>
                  ...
                  <div class="nk-data data-list">
                    <div class="data-head">
                      <h6 class="overline-title">Specialist</h6>
                    </div>
                    <div class="data-item">
                      <div class="data-col">
                        ...
                        <span class="data-value">
                          <span>
                            @if (App::getLocale()=='ar')
                            {{ Auth::user()->companyUser->sectionCompany->name_ar }}
                            @else
                            {{ Auth::user()->companyUser->sectionCompany->name_en }}
                            @endif
                          </span>
                        </span>
                      </div>
