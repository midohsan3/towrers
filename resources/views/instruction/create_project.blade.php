      ...
      <div class="nk-content-body">
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between g-3">
            ...
            <div class="nk-block-head-content">
              <a href="{{ route('instruction.index') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex">
          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('instruction.store.project') }}" method="POST">
                  @csrf
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="project">{{ __('general.Project')
                          }}</label>
                        <div class="form-control-wrap">
                          <select class="form-select form-control form-control-sm" data-search="on" id="project"
                            name="project">
                            <option value="0" disabled selected>{{ __('admin.Choose...') }}
                            </option>
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="name_en">{{ __('general.English
                          Name')
                          }}</label>
                        <div class="form-control-wrap">
