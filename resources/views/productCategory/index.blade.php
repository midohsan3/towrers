                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                      ...
                      <div class="drodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <ul class="link-list-opt no-bdr">
                            <li><a href="{{ route('product.category.index') }}"><span>{{ __('general.All') }}</span></a>
                            </li>
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('product.category.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('product.category.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('product.category.edit',$section->id) }}"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('product.category.activate') }}" method="POST">
          @csrf
...
<div class="modal fade zoon" tabindex="-1" id="deactivateMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('product.category.deactivate') }}" method="POST">
          @csrf
          <input hidden id="section_Id" name="sectionID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
...
<div class="modal fade zoon" tabindex="-1" id="deleteMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('product.category.destroy') }}" method="POST">
          @csrf
