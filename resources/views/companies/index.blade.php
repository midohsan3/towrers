                      ...
                      <div class="drodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <ul class="link-list-opt no-bdr">
                            ...
                            <li><a href="{{ route('company.inactive') }}"><span>{{ __('general.Inactive')
                                  }}</span></a>
                            </li>
                            @if ($sections->count()>0)
                ...
                <table class="nk-tb-list nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      ...
                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('general.Interests')
                          }}</span></th>
                  ...
                  <tbody>
                    ...
                    <tr class="nk-tb-item">
                      <td class="nk-tb-col">
                        <a href="{{ route('company.show',$company->companyUser->id) }}">
                          <div class="user-card">
                            <div class="user-avatar bg-primary">
                              @if ($company->profile_pic !== null)
                              <img src="{{ url('storage/app/public/imgs/users/'.$company->profile_pic) }}"
                                alt="{{ $company->name }}" />
                              @else
                            ...
                            <div class="user-info">
                              <span class="tb-lead ">
                                @if (App::getLocale()=='ar')
                                {{ $company->companyUser->name_ar }}
                                @else
                                {{ $company->companyUser->name_en }}
                                @endif

                                @if ($company->companyUser->status==1)
                      ...
                      <td class="nk-tb-col tb-col-md">
                        ...
                        <span>
                          <a href="{{ route('communication.index',$company->companyUser->id) }}">
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <a href="{{ route('company.majors',$company->companyUser->id) }}">
                          <span class="tb-lead">
                            @if ($company->companyUser->section_id !==null)
                            @if (App::getLocale()=='ar')
                            {{ $company->companyUser->sectionCompany->name_ar }}
                            @else
                            {{ $company->companyUser->sectionCompany->name_en }}
                            @endif
                            @endif
                          </span>
                          <span>
                            @if (array_key_exists($company->companyUser->id,$majors))
                            {{ $majors[$company->companyUser->id] }} {{
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span>
                          @if (array_key_exists($company->id,$companyInterests))
                          {{ $companyInterests[$company->id] }} <s,pan>{{ __('general.Interest') }}</s,pan>
                          @else
                          <span class="text-danger">{{ __('general.No Interests') }}</span>
                          @endif
                        </span>
                      </td>
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span>
                          @if ($company->companyUser->city_id !==null)
                          @if (App::getLocale()=='ar')
                          {{ $company->companyUser->cityCompany->name_ar }}
                          @else
                          {{ $company->companyUser->cityCompany->name_en }}
                          @endif
                          @endif
                        </span>
                      </td>
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span class="td-lead">
                          @if ($company->companyUser->package_id !== null)
                          @if (App::getLocale()=='ar')
                          {{ $company->companyUser->packageCompany->name_ar }}
                          @else
                          {{ $company->companyUser->packageCompany->name_en }}
                          @endif
                          @endif
                        </span>
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <ul class="list-status">
                          <li>
                            @if ($company->companyUser->license !== null)
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <a href="{{ route('company.project.index',$company->companyUser->id) }}">
                          <span>
                            @if (array_key_exists($company->companyUser->id,$projects))
                            {{ $projects[$company->companyUser->id] }} <span>{{
                      ...
                      <td class="nk-tb-col tb-col-md">
                        @if ($company->companyUser->featured==1)
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span class="tb-lead">
                          @if ($company->companyUser->register_by==0)
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('company.edit',$company->companyUser->id) }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" data-placement="top"
                              title="{{ __('general.Deactivate') }}" data-sectionid="{{ $company->companyUser->id }}"
                              data-sectionnameen="{{ $company->companyUser->name_en }}"
                              data-sectionnamear="{{ $company->companyUser->name_ar }}" data-toggle="modal"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-success" data-placement="top"
                              title="{{ __('general.Activate') }}" data-sectionid="{{ $company->companyUser->id }}"
                              data-sectionnameen="{{ $company->companyUser->name_en }}"
                              data-sectionnamear="{{ $company->companyUser->name_ar }}" data-toggle="modal"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" title="{{ __('general.Delete') }}"
                              data-sectionid="{{ $company->companyUser->id }}"
                              data-sectionnameen="{{ $company->companyUser->name_en }}"
                              data-sectionnamear="{{ $company->companyUser->name_ar }}" data-toggle="modal"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('company.about',$company->companyUser->id) }}" class="text-info">
                                  ...
                                  @if ($company->companyUser->featured==1)
                                  <li>
                                    <a href="#" class="text-danger" data-sectionid="{{ $company->companyUser->id }}"
                                      data-sectionnameen="{{ $company->companyUser->name_en }}"
                                      data-sectionnamear="{{ $company->companyUser->name_ar }}" data-toggle="modal"
                                  ...
                                  @else
                                  <li>
                                    <a href="#" class="text-success" data-sectionid="{{ $company->companyUser->id }}"
                                      data-sectionnameen="{{ $company->companyUser->name_en }}"
                                      data-sectionnamear="{{ $company->companyUser->name_ar }}" data-toggle="modal"
                                  ...
                                  <li>
                                    <a href="#" class="text-warning" data-sectionid="{{ $company->companyUser->id }}"
                                      data-sectionnameen="{{ $company->companyUser->name_en }}"
                                      data-sectionnamear="{{ $company->companyUser->name_ar }}" data-toggle="modal"
