            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('front.companies') }}"><strong
                      style="font-size: 1.5em; color: blue;">{{ __('front.Companies') }}</strong></a>
                </li>
        ...
        <div class="col-md-2">
          <div id="shortcodes" class="widget widget_links">
            ...
            <ul>
              ...
              <li><a href="{{ route('front.companies.major',['section'=>$section->id,'major'=>$major->id]) }}">
                  <div>
                    @if (App::getLocale()=='ar')
                    {{ $major->name_ar }}
                    @else
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
                ...
                <div class="fbox-content">
                  <h3 class="mb-4 text-transform-none ls-0"><a href="{{ route('front.companies.single',$company->id) }}"
