        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            ...
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('product.Products Glary') }}</h3>
        ...
        <div class="card">
          <div class="card-inner">
            <div class="preview-block">
              ...
              <form action="{{ route('product.photos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="preview-block">
              ...
              <div class="row g-3 d-flex justify-content-center">
                ...
                <div class="col col-md-3">
                  <div class="card">
                    <img src="{{ url('storage/app/public/imgs/products') . '/' . $photo->photo }}" class="card-img-top"
                    ...
                    <div class="card-inner">
                      <div class="d-flex justify-content-between">
                        ...
                        @else
                        <a href="{{ route('product.photos.activate',$photo->id) }}"
                          class="btn-xs btn btn-primary mr-1">{{ __('project.Set Default') }}</a>
                        @endif

                        <a href="{{ route('product.photos.destroy',$photo->id) }}"
