          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">
                {{ __('package.Package') }}/ <strong class="text-primary small">
                  @if (App::getLocale()=='ar')
                  {{ $package->name_ar }}
                  @else
                  {{ $package->name_en }}
            ...
            <div class="nk-block-head-content">
              <a href="{{ route('package.classified.index') }}"
          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('package.classified.update') }}" method="POST">
                  @csrf
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="form-control-wrap">
                          <input hidden class="form-control" id="package_id" name="package_id"
                            value="{{ $package->id }}" />
                          @error('package_id')
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_ar"
                            placeholder="{{ __('general.Arabic Name') }}" value="{{ old('name_ar',$package->name_ar) }}"
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_en"
                            ...
                            value="{{ old('name_en',$package->name_en) }}" autocomplete>
                          @error('name_en')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                  ...
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="position">{{ __('package.Position') }}</label>
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="position" name="position"
                            placeholder="{{ __('package.Classified Position') }}"
                            value="{{ old('position',$package->position) }}" />
                          @error('position')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="size">{{ __('classified.Size') }}</label>
                        <div class="form-control-wrap">
                          <select class="form-control" id="size" name="size">
                            <option disabled selected>{{ __('general.Choose') }}</option>
                            @foreach ($sizes as $size)
                            @if ($size->id ==$package->size_id)
                            <option value="{{ $size->id }}" selected>{{ $size->title }}-
                              {{ $size->width }}X{{ $size->height }}Px
                            </option>
                            @else
                            <option value="{{ $size->id }}">{{ $size->title }}- {{ $size->width }}X{{ $size->height }}Px
                            </option>
                            @endif
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          ...
                          <input type="text" class="form-control" id="price" name="price"
                            ...
                            value="{{ number_format(old('price',$package->price),2) }}" />
                          @error('price')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          ...
                          <input type="text" class="form-control" id="period" name="period"
                            placeholder="{{ __('general.Arabic Name') }}"
                            value="{{ number_format(old('period',$package->period),0) }}" />
                          @error('period')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
