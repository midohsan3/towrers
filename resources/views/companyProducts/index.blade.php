          ...
          <div class="nk-block-between">
            ...
            <div class="nk-block-head-content">
              ...
              <div class="nk-block-des text-soft">
                <p>{{ __('general.You have total') }} {{ number_format($productsCount,0) }} {{ __('product.Product') }}.
                </p>
              </div>
            </div>
                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('c-company.product.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('c-company.product.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                ...
                <table class="nk-tb-list is-separate nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      ...
                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('product.Quantity') }}</span></th>

                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('product.Price') }}</span></th>

                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('product.Description') }}</span></th>

                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('general.Photos') }}</span></th>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <div class="user-card">
                          <div class="user-avatar bg-purple">
                            ...
                            <img src="{{ url('storage/app/public/imgs/products/'.$product->main_pic) }}"
                              alt="{{ $product->name_en }}" />
                            @else
                            <span class="text-uppercase">{{ Str::substr($product->name_en,0,2) }}</span>
                            @endif
                          </div>
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span class="amount">{{ number_format($product->price,2) }} <span
                            class="currency">{{ __('general.AED') }}</span></span>
                      </td>
                      ...
                      <td class="nk-tb-col tb-col-mb">
                        <a href="{{ route('product.photos.index',$product->id) }}">
                          ...
                          <span class="amount">{{ $photos[$product->id] }} <span
                              class="currency">{{ __('general.Photos') }}</span></span>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('c-company.product.edit',$product->id) }}"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('c-company.product.edit',$product->id) }}" class="text-success">
