          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong
                  class="text-primary small">{{__('project.Edit Project')}}</strong>
              </h3>
            </div>
            <div class="nk-block-head-content">
              <a href="{{ route('project.index') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex">
              ...
              <div class="preview-block">
                ...
                <form action="{{ route('project.update') }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_ar"
                            placeholder="{{ __('general.Arabic Name') }}" value="{{ old('name_ar',$project->name_ar) }}"
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_en"
                            ...
                            value="{{ old('name_en',$project->name_en) }}" autocomplete />
                          @error('name_en')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                  ...
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="progress">{{ __('project.Progress') }}</label>
                        <div class="form-control-wrap">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="category">{{ __('general.Categories') }}</label>
                        <div class="form-control-wrap">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="tinymce-basic form-control" name="description_ar"
                            placeholder="{{ __('project.Arabic Description Here') }}">{{ old('description_ar',$project->description_ar) }}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="tinymce-basic form-control" name="description_en"
                            placeholder="{{ __('project.English Description Here') }}">{{ old('description_en',$project->description_en) }}</textarea>
                  ...
                  <div class="row gy-4">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control form-control-sm" id="pac-input" name="address"
                            value="{{ old('address',$project->address) }}" autocomplete />
                          @error('address')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                    ...
                    <input hidden id="latitude" name="lat" value="{{ old('lat',$project->lat) }}" />
                    <input hidden id="longitude" name="long" value="{{ old('lng',$project->lng) }}" />
                  </div>
