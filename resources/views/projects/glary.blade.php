        ...
        <div class="card">
          <div class="card-inner">
            <div class="preview-block">
              ...
              <form action="{{ route('project.photo.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="card">
                    ...
                    <div class="card-inner">
                      <div class="d-flex justify-content-between">
                        ...
                        @else
                        <a href="{{ route('project.photo.def',$photo->id) }}"
                          class="btn-xs btn btn-primary mr-1">{{ __('project.Set Default') }}</a>
                        @endif

                        <a href="{{ route('project.photo.destroy',$photo->id) }}"
