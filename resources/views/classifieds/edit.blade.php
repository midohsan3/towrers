          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong
                  class="text-primary small">{{__('classified.Edit Classified')}}</strong>
              </h3>
            </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="form-control-wrap">
                          <input hidden name="classified_id" value="{{ $classified->id }}" />
                          @error('classified_id')
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <select class="selectpicker form-control" name="user" data-live-search="true" id="user">
                            ...
                            @if ($user->id == $classified->user_id)
                            <option value="{{ $user->id }}" data-tokens="{{ $user->email }}" selected>
                              {{ $user->email }}
                            </option>
                            @else
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_ar"
                            placeholder="{{ __('classified.Arabic Title') }}"
                            value="{{ old('name_ar',$classified->title_ar) }}" autocomplete autofocus>
                          @error('name_ar')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_en"
                            placeholder="{{ __('classified.English Title') }}"
                            value="{{ old('name_en',$classified->title_en) }}" autocomplete>
                          @error('name_en')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                  ...
                  <div class="row gy-4">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <select class="form-control" id="package" name="package">
                            ...
                            @if ($package->id ==$classified->classified_package_id)
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="link" name="link"
                            value="{{ old('link',$classified->link) }}"
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                        @enderror
                        <input hidden name="old_photo" value="{{ $classified->photo }}" />
                      </div>
                    </div>

                    <div class="col-sm-6">
                      <img src="{{ url('storage/app/public/imgs/ads/'.$classified->photo) }}" class="img-thumbnail" />
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap" id="new_amount">
                          <input type="text" class="form-control" name="amount" id="amount"
                            value="{{ old('amount',$classified->paid_amount) }}" />
                          @error('amount')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" name="phone" id="phone"
                            value="{{ old('phone',$classified->phone)}} " />
                          @error("phone")
                          <span class="bg-danger text-white" role="alert"> {{ $message}} </span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" name="whatsapp" id="whatsapp"
                            value="{{ old('whatsapp',$classified->whatsapp)}} " />
                          @error("whatsapp")
                          <span class="bg-danger text-white" role="alert">{{ $message}} </span>
                          @enderror
                        </div>
