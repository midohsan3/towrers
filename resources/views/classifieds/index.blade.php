                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('classified.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('classified.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('classified.edit',$classified->id) }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" data-placement="top"
                              title="{{ __('general.Deactivate') }}" data-packageid="{{ $classified->id }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-success" data-placement="top"
                              title="{{ __('general.Activate') }}" data-packageid="{{ $classified->id }}"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('classified.edit',$classified->id) }}" class="text-success">
                                  ...
                                  @else
                                  <li>
                                    <a href="#" class="text-success" data-packageid="{{ $classified->id }}"
                                      data-toggle="modal" data-target="#activateMdl">
                                      <i class="icon fal fa-power-off"></i>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('classified.activate') }}" method="POST">
          @csrf
          <input hidden id="package_id" name="classifiedID" />
...
<div class="modal fade zoon" tabindex="-1" id="deactivateMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('classified.deactivate') }}" method="POST">
          @csrf
          <input hidden id="package_Id" name="classifiedID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
