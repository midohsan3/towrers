        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            ...
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('general.Units') }}</h3>
              <div class="nk-block-des text-soft">
                <p>{{ __('general.You have total') }} {{ number_format($unitsCount,0) }} {{ __('product.Unit') }}.
                </p>
              </div>
            </div>
                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('unit.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('unit.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                      ...
                      <td class="nk-tb-col">
                        <div class="user-card">
                          <div class="user-avatar bg-primary">
                            <span class="text-uppercase">{{ substr($unit->name_en,0,2) }}</span>
                          </div>
                          <div class="user-info">
                            <span class="tb-lead ">
                              @if (App::getLocale()=='ar')
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('unit.edit',$unit->id) }}" class="btn btn-trigger btn-icon text-success"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('unit.edit',$unit->id) }}" class="text-success">
