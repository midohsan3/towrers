          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong
                  class="text-primary small">{{__('product.New Unit')}}</strong>
              </h3>
            </div>
            <div class="nk-block-head-content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name" name="name"
                            placeholder="{{ __('classified.Title Here') }}" value="{{ old('name') }}" autocomplete
                            autofocus>
                          @error('name')
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          ...
                          <input type="number" class="form-control" id="width" name="width"
                            placeholder="{{ __('classified.Width Here') }}" value="{{ old('width',0) }}" />
                          @error('width')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          ...
                          <input type="text" class="form-control" id="height" name="height"
                            value="{{ old('height',0) }}" autocomplete>
                          @error('height')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
