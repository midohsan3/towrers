          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong
                  class="text-primary small">{{__('general.Edit Video')}}</strong>
              </h3>
            </div>
            <div class="nk-block-head-content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="tinymce-basic form-control" name="description_ar"
                            placeholder="{{ __('general.Arabic Description Here') }}">{{ old('description_ar',$video->description_ar) }}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="tinymce-basic form-control" name="description_en"
                            placeholder="{{ __('general.English Description Here') }}">{{ old('description_en',$video->description_en) }}</textarea>
