                    ...
                    <tr class="nk-tb-item">
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="#" class="btn btn-trigger btn-icon text-danger" data-sliderid="{{ $slider->id }}"
                              title="{{ __('general.Delete') }}" data-toggle="modal" data-target="#deleteMdl">
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="#" class="text-danger" data-sliderid="{{ $slider->id }}"
          ...
          <div class="row gy-4">
            <div class="col">
              <div class="form-group">
                ...
                <div class="form-control-wrap">
                  <select class="selectpicker form-control" name="company_id" data-live-search="true" autofocus>
...
<div class="modal fade zoon" tabindex="-1" id="deleteMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('slider.company.destroy') }}" method="POST">
          @csrf
          <input hidden id="sliderId" name="sliderID" />
        ...
        $(function() {      
            ...
            */
            $('#deleteMdl').on('show.bs.modal', function(e) {
                ...
                let id = button.data('sliderid');
                //console.log(id);
                var modal = $(this);
                modal.find('.modal-body #sliderId').val(id);
            });
