        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            ...
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('slider.Main Sliders List') }}</h3>
                ...
                <table class="nk-tb-list is-separate nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      <th class="nk-tb-col"><span class="sub-text">{{ __('slider.Title') }}</span></th>

                      <th class="nk-tb-col tb-col-md"><span class="sub-text">{{ __('slider.URL') }}</span></th>
                      </th>
                  ...
                  <tbody>
                    ...
                    <tr class="nk-tb-item">
                      <td class="nk-tb-col">
                        <a href="{{ route('slider.main.edit',$slider->id) }}" class="project-title">
                          ...
                          <div class="project-info">
                            ...
                            @if (App::getLocale()=='ar')
                            <span class="tb-lead "> {{ $slider->small_head_ar }} </span>
                            <strong>{{ $slider->head_ar }}</stro>
                              @else
                              <span class="tb-lead "> {{ $slider->small_head_en }} </span>
                              <strong>{{ $slider->head_en }}</strong>
                              @endif
                          </div>
                        </a>
                      </td>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('slider.main.edit',$slider->id) }}"
                          ...
                          @if ($slider->status==1)
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('slider.main.deactivate',$slider->id) }}"
                          ...
                          @else
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('slider.main.activate',$slider->id) }}"
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('slider.main.destroy',$slider->id) }}"
                              class="btn btn-trigger btn-icon text-danger" title="{{ __('general.Delete') }}">
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('slider.main.edit',$slider->id) }}" class="text-primary">
                                      <em class="icon ni ni-edit"></em>
                                  ...
                                  @if ($slider->status==1)
                                  <li>
                                    <a href="{{ route('slider.main.deactivate',$slider->id) }}" class="text-danger">
                                      <i class="icon fal fa-power-off"></i>
                                  ...
                                  @else
                                  <li>
                                    <a href="{{ route('slider.main.activate',$slider->id) }}" class="text-success">
                                      <i class="icon fal fa-power-off"></i>
                                  ...
                                  <li>
                                    <a href="{{ route('slider.main.destroy',$slider->id) }}" class="text-danger">
          ...
          <div class="row gy-4">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="form-control-wrap">
                  <input type="text" class="form-control" id="small_title_ar" name="small_title_ar" autofocus />
                </div>
              </div>
            </div>
