...
{{-- 
  ...
  --}}
@section('title')
{{ __('users.Edit Personal Account') }}
@endsection
{{-- 
  =====================
  =PAGE CONTENT
          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong
                  class="text-primary small">{{__('users.Edit Personal Account')}}</strong>
              </h3>
            </div>
            <div class="nk-block-head-content">
              <a href="{{ route('person.index') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control form-control-sm" id="name" name="name"
                            placeholder="{{ __('users.Full Name') }}" value="{{ old('name',$user->name) }}" autocomplete
                            autofocus />
                          @error('name')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="email" class="form-control form-control-sm" id="email" name="email"
                            placeholder="xxxxx@xxxx.com" value="{{ old('email',$user->email) }}" />
                          @error('email')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
