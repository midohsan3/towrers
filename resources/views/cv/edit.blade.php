        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong class="text-primary small">{{ __('job.CV') }}/ <strong
            ...
            <div class="card-inner  ">
              <div class="preview-block">
                <div class="row justify-content-end">
                  <img src="{{ url('storage/app/public/imgs/jobs/'.$job->cv) }}" class="img-thumbnail" alt="...">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="preview-block">
                ...
                <form action="{{ route('cv.update') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="company">{{ __('general.User') }}</label>
                        <div class="form-control-wrap">
                          {{--  
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <div class="custom-file">
                            ...
                            <input hidden name="old_file" value="{{ $job->cv }}" />
                            @error('cv')
                            <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                            @enderror
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="experience" name="experience"
                            placeholder="{{ __('job.Experience') }}" value="{{ old('Experience',$job->experience) }}">
                          @error('Experience')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="email" class="form-control" id="email" name="email"
                            placeholder="{{ __('job.Email') }}" value="{{ old('email',$job->email) }}">
                          @error('email')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="phone" class="form-control" id="phone" name="phone"
                            placeholder="{{ __('job.Phone') }}" value="{{ old('phone',$job->phone) }}">
                          @error('phone')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="phone" class="form-control" id="whatsapp" name="whatsapp"
                            placeholder="{{ __('job.Whatsapp') }}" value="{{ old('whatsapp',$job->whats_app) }}">
                          @error('whatsapp')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
