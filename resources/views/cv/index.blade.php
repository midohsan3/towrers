                                                ...
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    <li class="nk-tb-action-hidden">
                                                        <a href="#" class="btn btn-trigger btn-icon text-danger"
                                                            data-placement="top" title="{{ __('general.Deactivate') }}"
                                                            data-jobid="{{ $job->id }}"
                                                            data-jobnameen="{{ $job->name_en }}"
                                                            data-jobnamear="{{ $job->name_ar }}" data-toggle="modal"
                                                    ...
                                                    @can('cvs-activate')
                                                    <li class="nk-tb-action-hidden">
                                                        <a href="#" class="btn btn-trigger btn-icon text-success"
                                                            data-placement="top" title="{{ __('general.Activate') }}"
                                                            data-jobid="{{ $job->id }}"
                                                            data-jobnameen="{{ $job->name_en }}"
                                                            data-jobnamear="{{ $job->name_ar }}" data-toggle="modal"
