        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">{{ __('job.Cvs List') }}</h3>
              <div class="nk-block-des text-soft">
                <p>{{ __('general.You have total') }} {{ number_format($jobsCount,0) }} {{
                  __('section.CV') }}.
                </p>
              </div>
            </div>
                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                      ...
                      <div class="drodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <ul class="link-list-opt no-bdr">
                            <li><a href="{{ route('cv.index') }}"><span>{{ __('general.All')
                                  }}</span></a>
                            </li>
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('cv.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('cv.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                ...
                <table class="nk-tb-list nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      ...
                      <th class="nk-tb-col tb-col-mb"><span class="sub-text">{{ __('job.Category')
                          }}</span></th>

                      <th class="nk-tb-col tb-col-mb"><span class="sub-text">{{ __('city.City')
                          }}</span></th>
                  ...
                  <tbody>
                    ...
                    <tr class="nk-tb-item">
                      <td class="nk-tb-col">
                        <a href="{{ asset('storage/app/public/imgs/jobs').'/'.$job->cv }}">
                          <div class="user-card">
                            <div class="user-avatar bg-primary">
                              <span class="text-uppercase">{{ substr($job->name_en,0,2)
                                }}</span>
                            </div>
                            <div class="user-info">
                              <span class="tb-lead ">
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('cv.edit',$job->id) }}" class="btn btn-trigger btn-icon text-success"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  @can('cvs-edit')
                                  <li>
                                    <a href="{{ route('cv.edit',$job->id) }}" class="text-success">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('cv.activate') }}" method="POST">
          @csrf
...
<div class="modal fade zoon" tabindex="-1" id="deactivateMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('cv.deactivate') }}" method="POST">
          @csrf
          <input hidden id="job_Id" name="jobID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
