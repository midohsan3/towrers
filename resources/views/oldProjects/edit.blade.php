          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('company.oldProjects.update') }}" method="POST">
                  @csrf
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="form-control-wrap">
                          <input hidden class="form-control" id="project" name="project" value="{{ $project->id }}" />
                          @error('project')
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="form-control" name="description_ar"
                            placeholder="{{ __('product.Arabic Description') }}">{{ old('description_ar',$project->description_ar) }}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="form-control" name="description_en"
                            placeholder="{{ __('product.English Description') }}">{{ old('description_en',$project->description_en) }}</textarea>
