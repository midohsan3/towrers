                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('section.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('section.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                ...
                <table class="nk-tb-list nk-tb-ulist">
                  <thead>
                    <tr class="nk-tb-item nk-tb-head">
                      ...
                      <th class="nk-tb-col tb-col-mb"><span class="sub-text">{{ __('section.Majors') }}</span></th>
                    ...
                    <tr class="nk-tb-item">
                      ...
                      <td class="nk-tb-col tb-col-md">
                        <span class="tb-amount">
                          @if (array_key_exists($section->id,$majors))
                          <a href="{{ route('section.major.index',$section->id) }}">
                            {{ $majors[$section->id] }}
                            <span class="currency">{{ __('section.Specialty') }}</span>
                          </a>
                          @else
                                ...
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="======" class="text-warning">
                                      <em class="icon ni ni-plus"></em>
                                      <span>{{ __('section.Add Major') }}</span>
                                    </a>
                                  </li>

                                  <li class="divider"></li>
                                  <li>
                                    <a href="{{ route('section.show',$section->id) }}" class="text-primary">
                                  ...
                                  <li>
                                    <a href="{{ route('section.edit',$section->id) }}" class="text-success">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('section.activate') }}" method="POST">
          @csrf
...
<div class="modal fade zoon" tabindex="-1" id="deactivateMdl">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('section.deactivate') }}" method="POST">
          @csrf
          <input hidden id="section_Id" name="sectionID" />
          <div class="row gy-4 m-auto p-auto">
            <p class="text-center">
