                ...
                <div class="toggle-expand-content" data-content="more-options">
                  <ul class="nk-block-tools g-3">
                    ...
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('c-company.job.create') }}" class="btn btn-icon btn-primary d-md-none">
                        <em class="icon ni ni-plus"></em>
                      </a>
                      <a href="{{ route('c-company.job.create') }}" class="btn btn-primary d-none d-md-inline-flex">
                        <em class="icon ni ni-plus"></em>
                      ...
                      <td class="nk-tb-col nk-tb-col-tools">
                        <ul class="nk-tb-actions gx-1">
                          ...
                          <li class="nk-tb-action-hidden">
                            <a href="{{ route('c-company.job.edit',$job->id) }}"
                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                  ...
                                  <li>
                                    <a href="{{ route('c-company.job.edit',$job->id) }}" class="text-success">
