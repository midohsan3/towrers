        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title"><strong class="text-primary small">{{__('general.My-CV')}}</strong>
              </h3>
            </div>
          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('person.cv.update') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="name_ar">{{ __('general.Arabic Title') }}</label>
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_ar"
                            placeholder="{{ __('general.Arabic Title') }}" value="{{ old('name_ar',$cv->name_ar) }}"
                            autocomplete />
                          @error('name_ar')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-label" for="name_en">{{ __('general.English Title') }}</label>
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_en"
                            placeholder="{{ __('general.English Title') }}" value="{{ old('name_en',$cv->name_en) }}"
                            autocomplete>
                          @error('name_en')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="form-control" name="description_ar"
                            placeholder="{{ __('project.Arabic Description Here') }}">{{ old('description_ar',$cv->description_ar) }}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <textarea class="form-control" name="description_en"
                            placeholder="{{ __('project.English Description Here') }}">{{ old('description_en',$cv->description_en) }}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <div class="custom-file">
                            ...
                            <input hidden name="old_file" value="{{ $cv->cv }}" />
                            @error('cv')
                            <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                            @enderror
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="experience" name="experience"
                            placeholder="{{ __('job.experience') }}" value="{{ old('experience',$cv->experience) }}" />
                          @error('experience')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="email" class="form-control" id="email" name="email"
                            placeholder="{{ __('job.Email') }}" value="{{ old('email',$cv->email) }}">
                          @error('email')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="phone" class="form-control" id="phone" name="phone"
                            placeholder="{{ __('job.Phone') }}" value="{{ old('phone',$cv->phone) }}">
                          @error('phone')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="phone" class="form-control" id="whatsapp" name="whatsapp"
                            placeholder="{{ __('job.Whatsapp') }}" value="{{ old('whatsapp',$cv->phone) }}">
                          @error('whatsapp')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
