          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('person.cv.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row gy-4">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_ar"
                            placeholder="{{ __('general.Arabic Title') }}" value="{{ old('name_ar') }}" autocomplete />
                          @error('name_ar')
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control" id="name_ar" name="name_en"
                            placeholder="{{ __('general.English Title') }}" value="{{ old('name_en') }}" autocomplete>
                          @error('name_en')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input sm" id="customFile" name="cv" required>
                            @error('cv')
                            <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                            @enderror
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="email" class="form-control" id="email" name="email"
                            placeholder="{{ __('job.Email') }}" value="{{ old('email',$pMail) }}">
                          @error('email')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="phone" class="form-control" id="phone" name="phone"
                            placeholder="{{ __('job.Phone') }}" value="{{ old('phone',$pPhone) }}">
                          @error('phone')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="phone" class="form-control" id="whatsapp" name="whatsapp"
                            placeholder="{{ __('job.Whatsapp') }}" value="{{ old('whatsapp',$pWhatsApp) }}">
                          @error('whatsapp')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
                        </div>
